...
% 5. options:   options for controling inversion process
    ...
    struct(...
        ...
        'load', struct(...
            'mode', 'segy', ...
            'fileName', 'C:\Users\binst\HRS projects\GEO_POST\model\modelall_Volume_PP_IMP.sgy', ...
    ...
    struct(...
        ...
        'load', struct(...
            'mode', 'segy', ...
            'fileName', 'D:\data\seismic data\geo-block\data\seismic\seismic.sgy', ...
    ...
    struct(...
        'name', 'DLSR', ...
        'flag', 'DLSR', ...
        'regParam', struct('lambda', 2, 'gamma', 0), ...
        'parampkgs', struct('GSparseInvParam', GSparseInvParam), ...
        'options', bsSetFields(seisInvOptions, {'maxIter', 10; 'innerIter', 60; 'initRegParam', 0.5}), ...
        'showFiltCoef', 1, ...
        'load', struct(...
            'mode', 'mat', ...
            'fileName', '' ...
