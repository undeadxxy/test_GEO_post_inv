...
%     ); 
    ...
    struct(...
        'name', 'DLSR_01_16 (gamma=0.3 sparsity=1)', ...
        'flag', 'DLSR', ...
        'regParam', struct('lambda', 1, 'gamma', 0.3), ...
    ...
    struct(...
        'name', 'DLSR_01_16 (gamma=0.3 sparsity=2)', ...
        'flag', 'DLSR', ...
        'regParam', struct('lambda', 1, 'gamma', 0.3), ...
...
bsWriteInvResultsIntoSegyFiles(GInvParam, invResults2D, ...
    sprintf('NLM_2020_01_16 _inline_[%d_%d]_crossline_[%d_%d]', ...
